        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshedTokenExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConnectionId = table.Column<string>(type: "NVARCHAR(500)", nullable: false),
                    UserId = table.Column<string>(type: "NVARCHAR(36)", maxLength: 36, nullable: false),
                    GroupId = table.Column<string>(type: "NVARCHAR(500)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicId = table.Column<string>(type: "NVARCHAR(500)", nullable: true),
